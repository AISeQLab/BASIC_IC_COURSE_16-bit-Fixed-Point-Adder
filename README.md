...
Synthesize and implement the design for the ZCU102 board.

Program the FPGA and run the provided testbench.

Observe results using the UART or simulation waveform.

Author

Pham Hoai LuanNara Institute of Science and Technology (NAIST), Japan
